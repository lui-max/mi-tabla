  ...
  useEffect(() => {
    const cargar = async () => {
      try {
        ...
        alert("❌ Error cargando registros: " + e.message);
      } finally {
        setCargando(false);
      }
    };
      ...
      {registrosFiltrados.map((r) => (
        <div key={r.id} style={{ marginBottom: 20 }}>
          ...
          <div style={s.card}>
            ...
            {(r.juegos || []).map((row, i) => {
              const t7 =
                parseInt(row.tickets) || 0;

              const t6 =
                parseInt(row.tickets6) || 0;
