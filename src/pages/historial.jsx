...
export default function Historial({ onVolver }) {
  ...
  const s = {
    ...
    card: { background:"#fff", border:"2px solid #1a1a2e", borderRadius:4, marginBottom:16, overflow:"hidden", boxShadow:"3px 3px 0 #1a1a2e" },
        ...
        <div key={r.id} style={{marginBottom:20}}>
          ...
          <div style={s.card}>
            ...
            <div style={{display:"grid", gridTemplateColumns:"1fr 1fr 55px 55px 75px", background:"#f1f5f9", borderTop:"2px solid #1a1a2e"}}>
              ...
              <div style={{padding:"6px 4px", fontSize:13, borderLeft:"1px solid #ccc"}}></div>
